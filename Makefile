...
CFLAGS_SQLITE := $(CFLAGS_SHARED) -DSQLITE_THREADSAFE=0 -DSQLITE_OS_OTHER=1 -DSQLITE_DQS=0 -DSQLITE_DEFAULT_MEMSTATUS=0 -DSQLITE_OMIT_DEPRECATED -DSQLITE_USE_ALLOCA -DHAVE_MALLOC_USABLE_SIZE -DSQLITE_TEMP_STORE=3 -DSQLITE_OMIT_DESERIALIZE -DSQLITE_OMIT_EXPLAIN -DSQLITE_OMIT_GET_TABLE -DSQLITE_OMIT_INTROSPECTION_PRAGMAS -DSQLITE_OMIT_PROGRESS_CALLBACK -DSQLITE_OMIT_TRACE -DSQLITE_OMIT_COMPLETE -DSQLITE_OMIT_COMPILEOPTION_DIAGS -DSQLITE_OMIT_AUTHORIZATION -DSQLITE_OMIT_LOCALTIME -DSQLITE_OMIT_JSON -DSQLITE_OMIT_LOAD_EXTENSION -DSQLITE_OMIT_INCRBLOB -DSQLITE_OMIT_SHARED_CACHE -DSQLITE_OMIT_TCL_VARIABLE -DSQLITE_OMIT_UTF16 -DSQLITE_OMIT_WAL -DSQLITE_USE_MALLOC_H -DSQLITE_ENABLE_MEMSYS5 -DSQLITE_DEFAULT_MEMSTATUS=0 -DSQLITE_ZERO_MALLOC -Wno-everything
