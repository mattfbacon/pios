...
void pwm_init_clock(uint32_t divisor);
...
void pwm_fifo_write(pwm_controller_t controller, uint32_t value);

void pwm_set_range(pwm_controller_t controller, pwm_channel_t channel, uint32_t range);
void pwm_set_data(pwm_controller_t controller, pwm_channel_t channel, uint32_t data);
